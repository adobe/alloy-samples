# Personalization profile based targeting

## Overview

Experience Decision Targeting (ExD Targeting) delivers personalization content to specific audience based on marketer defined set of rules.  
The name Experience Decision Targeting is derived from the fact that Experience/Content is Targeted to specific audience based on rules.

**Marketer** runs a campaign with multiple targeting criteria using the decision tree that delivers different experience/content.  
**Visitors** are evaluated against the defined criteria. Based on matched criteria, visitors are delivered with appropriate experience/content within the campaign.

This sample demonstrates profile based targeting to get personalization content from AJO code based experience campaign. 
The web page changes based on the personalization content returned.
