...
function applyPersonalization(surfaceName) {
  return function (result) {
    ...
    console.log("filtered proposition", proposition);
    ...
    if (proposition) {
      ...
      const {
        greeting = "Greetings",
        description = "This is a personalized experience.",
        buttonActions = [],
        heroImageName = "demo-marketing-decision1-default.png",
      } = proposition.items[0].data.content;

      document.querySelector(".page-header h1").textContent = greeting;
      document.getElementById("paragraph-text-2").textContent = description;
