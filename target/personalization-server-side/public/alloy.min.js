  ...
  if (document.documentMode && document.documentMode < 11)
    ...
    var e = "Chrome",
      ...
      d = (function () {
        ...
        ? Object.assign
        : function (e, n) {
            for (var t, r, o = Bo(e), i = 1; i < arguments.length; i++) {
    ...
    var v = function (e) {
      ...
      m = function (e) {
        return !v(e) && !Array.isArray(e) && "object" === Vo(e);
      },
      h = function e(n, t) {
      ...
      C = function (e) {
        ...
        return Ho(
          ...
          {
            set: function (e, r, o) {
              n.info("Setting cookie", Ho({ name: e, value: r }, o)),
                t.set(e, r, o);
            },
          }
        );
    ...
    for (
      ...
      Pe[xe] = (xe + 256).toString(16).substr(1);
    var qe = function (e, n) {
        var t = n || 0,
          r = Pe;
        return [
      ...
      Ue = function (e, n) {
        return Te(A(e), e, n, "a function"), e;
      },
      Be = function (e, n) {
        return function (t, r) {
      ...
      Fe = function (e) {
        return function (n, t) {
          return m(n) ? Te(!fe(n), n, t, e) : Te(n.length > 0, n, t, e), n;
        };
      },
      _e = /^[a-z0-9.-]{1,}$/i,
      He = function (e, n) {
    ...
    var Xe = function () {
      ...
      Ke = function () {
        return Ae(this, Ve, { minimum: Ge });
      },
      Ye = function () {
        return Ae(this, Fe("a non-empty string"));
      },
      Ze = function () {
        return Ae(this, Fe("a non-empty array"));
      },
      en = function () {
        return Ae(this, Fe("a non-empty object"));
      },
      nn = function () {
        return Ae(this, ze);
      },
    ...
    (function () {
      return Ae(this, Le, { minimum: $e, integer: Ke, unique: tn });
    }).bind(Qe);
    var dn = function (e) {
        return Ae(
          this,
            ...
            applyHandles: {
              ...
              optionsValidator: function (e) {
                return (function (e) {
                  ...
                  return fn({
                    renderDecisions: cn(),
                    handles: an(
                      fn({ type: ln().required(), payload: on().required() })
                    ).required(),
                  })(n);
                })({ options: e });
              },
              run: function (e) {
                var t = e.renderDecisions,
                  ...
                  i = void 0 === o ? [] : o,
                  a = n.createEvent();
                return n.applyHandles(a, { renderDecisions: r, handles: i });
              },
            },
          },
        };
      };
    (Nn.namespace = "DataCollector"), (Nn.configValidators = {});
    var An = function (e) {
        var n = e.config,
          t = e.eventManager,
          r = e.lifecycle,
    ...
    (Un.namespace = "ActivityCollector"), (Un.configValidators = Tn);
    var Bn,
      Fn,
      _n,
      Hn = function (e, n) {
      ...
      zn = fn({ url: ln().required().nonEmpty() }).required().noUnknownFields(),
      Jn = function (e) {
        var n = e.logger;
        return new Promise(function (e, t) {
      ...
      ct = function (e) {
        var n = e.config,
            ...
            return {
              ...
              setEcid: function (e) {
                if (a && u() !== e) {
                  ...
                  i.set(c, "MCMID|" + e, Ho({ domain: r, expires: 390 }, n));
                }
              },
            };
          })({
          ...
          v = (function (e) {
            ...
            return function (e) {
              n && t(Gn(window)) && e.setUseIdThirdPartyDomain();
            };
          })({
          ...
          })({ getLegacyEcid: d.getEcid, addEcidToPayload: $n }),
          h = (function (e) {
            ...
            (function (e) {
              e.filter(function (e) {
                ...
                var n = e.spec,
                  ...
                  a = n.domain,
                  c = n.ttlDays;
                r.set(t, i || "", Ho({ domain: a || "", expires: c || 10 }, o));
              });
            })(e),
            (function (e) {
              var r = e.filter(function (e) {
    ...
    var lt,
      ...
      vt = "https://ns.adobe.com/personalization/dom-action",
      mt = "https://ns.adobe.com/personalization/html-content-item",
              ...
              var h = (function (e) {
                ...
                return {
                  ...
                  createQueryDetails: function () {
                    ...
                    return (
                      o(e, pt) && n.push(vt), { schemas: n, decisionScopes: e }
                    );
                  },
    ...
    (Yo.prototype.catch = function (e) {
      ...
      (Yo.prototype.then = function (e, n) {
        var t = new this.constructor(Ko);
        return Zo(this, new ri(e, n, t)), t;
      }),
      (Yo.prototype.finally = function (e) {
      ...
      (Yo.all = function (e) {
        return new Yo(function (n, t) {
          ...
          function i(e, a) {
            try {
              if (a && ("object" === Vo(a) || "function" == typeof a)) {
                var c = a.then;
      ...
      (Yo.resolve = function (e) {
        return e && "object" === Vo(e) && e.constructor === Yo
          ? e
          : new Yo(function (n) {
              n(e);
            });
      ...
      (Yo.race = function (e) {
        return new Yo(function (n, t) {
          ...
          for (var r = 0, o = e.length; r < o; r++) Yo.resolve(e[r]).then(n, t);
        });
      }),
      (Yo._immediateFn =
    ...
    var Gt,
      $t =
        ((Gt = Object.freeze({ __proto__: null, default: Yo })) &&
          Gt.default) ||
        Gt,
      Kt =
      ...
      Pr = function (e, n) {
        e.mergeQuery({ personalization: Ho({}, n) });
      },
      xr = function (e) {
        var n = e.decisions,
          t = e.renderAttempted;
      ...
      Ar = function (e) {
        ...
        return (
          e.forEach(function (e) {
            var n = e.items,
              r = Jo(Mr(void 0 === n ? [] : n, t), 2),
              a = r[0],
              c = r[1];
            T(a) && o.push(Nr(e, a)), T(c) && i.push(Nr(e, c));
          }),
      ...
      Tr = function (e) {
        var n,
          ...
          c = Ar(a.unmatchedDecisions, vt, gt),
          u = (function (e) {
            var n = [],
              t = [],
              r = {};
        ...
        return {
          ...
          nonAutoRenderableDecisions: [].concat(
            Wo(a.matchedDecisions),
            Wo(c.unmatchedDecisions),
            Wo(d)
          ),
        };
      },
      ...
      _r = function (e) {
        var n,
          ...
          })({ eventManager: e.eventManager, mergeDecisionsMeta: Or }),
          a = jr(),
              ...
              return Promise.resolve(a)
                ...
                .then(function (e) {
                  return (
                    ...
                    r(),
                    [].concat(
                      Wo(e.pageWideScopeDecisions),
                      Wo(e.viewPropositions)
                    )
                  );
                })
                .then(function (e) {
                  return {
                    decisions: Wo(c),
                    propositions: [].concat(
                      Wo(xr({ decisions: e, renderAttempted: !0 })),
                      Wo(xr({ decisions: c, renderAttempted: !1 }))
                    ),
                  };
                });
            };
    ...
    var Hr,
      ...
      $r = function (e) {
        ...
        })(e.config, e.logger, Xr, Gr);
      };
    ($r.namespace = "Context"),
      ($r.configValidators = { context: an(ln()).default(Object.keys(Xr)) });
    var Kr = function e(n) {
      ...
      oo = fn({ consent: an(on()).required().nonEmpty(), identityMap: gn })
        .noUnknownFields()
        .required(),
      io = function (e) {
        var n,
    ...
    var lo,
      po,
      go = [Nn, Un, ct, ft, _r, $r, io, co, uo, fo],
      vo = function (e) {
        var n = e.options,
          ...
          u = o(
            (function (e, n) {
              try {
                return fn(e).noUnknownFields().required()(n);
              } catch (e) {
                throw new Error(
      ...
      bo = function (e) {
        var n = e.cookieJar,
          ...
          o = e.dateProvider;
        return {
          getPathFromCookie: function () {
            return n.get(ce(t, "path"));
          },
      ...
      Co = function (e) {
        var n = e.shift() || [],
          t = e.shift() || [],
          r = e;
        return f.apply(void 0, [{}].concat(Wo(n), Wo(t), Wo(r)));
      },
      Eo = "The server responded with a",
      Io = [429, 503, 502, 504],
      Do = function (e) {
        var n = e.response;
        return e.retriesAttempted < 3 && o(Io, n.statusCode);
      },
      Ro = function (e) {
        var n = e.response,
      ...
      No = {
        ...
        onBeforeEventSend: un().default(me),
      },
      Ao = (function (e, n) {
        for (
          var t,
              ...
              var t = vo({
                ...
                d = A(xo.sendBeacon)
                  ? (function (e) {
                      ...
                      sendBeacon: xo.sendBeacon.bind(xo),
                      sendFetchRequest: To,
                      logger: o,
                    })
                  : To,
                f = (function (e) {
                        ...
                        return (s ? r : t)(c, d).then(function (t) {
                          ...
                          return (
                            n.logOnNetworkResponse(
                              Ho(
                                Ho({ requestId: a, url: c, payload: f }, t),
                                {},
                  ...
                  sendFetchRequest: To,
                  sendBeaconRequest: d,
                  isRequestRetryable: Do,
                  getRequestRetryDelay: Ro,
                }),
                l = (function (e) {
                  var n = e.logger;
                  return function (e) {
                  ...
                  return function (e) {
                    ...
                    return (
                      ...
                      t
                        ...
                        .then(function () {
                          var e = r({ content: { handle: i }, getHeader: me });
                          return (
                            n.responseToCookies(e),
                            u.call({ response: e }).then(Co)
                          );
                        })
                    );
                  };
                })({ lifecycle: c, cookieTransfer: s, createResponse: g }),
                h = (function (e) {
                ...
                })({ generalConsentState: On({ logger: o }), logger: o }),
                y = (function (e) {
                  var n = e.config,
                    t = e.logger,
                    r = e.lifecycle,
                    ...
                    sendEvent: function (e) {
                      ...
                      return r
                        ...
                        .then(function () {
                          ...
                          if (!e.shouldSend()) {
                            v.add(r.onRequestFailure), t.info(wo);
                            var o = new Error(wo);
    ...
    (po = window.__alloyNS) &&
      po.forEach(function (e) {
        var n = vn({
          ...
          })(Uo({ instanceName: e, logController: n })),
          r = window[e].q;
        (r.push = t),
        ...
        Yo._immediateFn(function () {
          ...
          if (null !== t) {
            ...
            try {
              ...
              return void ni(n.promise, e);
            }
            ei(n.promise, r);
          } else (1 === e._state ? ei : ni)(n.promise, e._value);
        }))
      : e._deferreds.push(n);
  }
  function ei(e, n) {
    try {
      ...
      if (n && ("object" === Vo(n) || "function" == typeof n)) {
        var t = n.then;
        if (n instanceof Yo) return (e._state = 3), (e._value = n), void ti(e);
      ...
      (e._state = 1), (e._value = n), ti(e);
    } catch (n) {
      ni(e, n);
    }
  }
  function ni(e, n) {
    (e._state = 2), (e._value = n), ti(e);
  }
  function ti(e) {
    2 === e._state &&
    ...
    for (var n = 0, t = e._deferreds.length; n < t; n++) Zo(e, e._deferreds[n]);
    e._deferreds = null;
  }
  function ri(e, n, t) {
