  ...
  if (document.documentMode && document.documentMode < 11)
    ...
    var e = "Chrome",
      ...
      d = (function () {
        ...
        ? Object.assign
        : function (e, n) {
            for (var t, r, o = Fo(e), i = 1; i < arguments.length; i++) {
    ...
    var v = function (e) {
      ...
      C = function (e) {
        ...
        return Lo(
          ...
          {
            set: function (e, r, o) {
              n.info("Setting cookie", Lo({ name: e, value: r }, o)),
                t.set(e, r, o);
            },
          }
        );
    ...
    var xe = function (e, n) {
      ...
      Fe = function (e) {
        return function (n, t) {
          return m(n) ? je(!fe(n), n, t, e) : je(n.length > 0, n, t, e), n;
        };
      },
      He = /^[a-z0-9.-]{1,}$/i,
      _e = function (e, n) {
        return je(He.test(e), e, n, "a valid domain"), e;
      },
      Le = function (e, n) {
            ...
            applyResponse: {
              ...
              optionsValidator: function (e) {
                return (function (e) {
                  ...
                  return fn({
                    renderDecisions: cn(),
                    responseHeaders: dn(ln().required()),
                    responseBody: fn({
                      handle: an(
    ...
    var Bn,
      ...
      $n =
        ((Bn = function (o) {
          var i, a;
          return (zo((i = {}), n, /Edge\/([0-9\._]+)/),
          zo(i, t, /Edg\/([0-9\.]+)/),
          zo(i, e, /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/),
          zo(i, "Firefox", /Firefox\/([0-9\.]+)(?:\s|$)/),
          zo(i, "IE", /Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/),
          zo(i, "Safari", /Version\/([0-9\._]+).*Safari/),
          (a = i),
          function (e) {
            ...
            return {
              ...
              setEcid: function (e) {
                if (a && u() !== e) {
                  ...
                  i.set(c, "MCMID|" + e, Lo({ domain: r, expires: 390 }, n));
                }
              },
            };
          })({
            ...
            (function (e) {
              e.filter(function (e) {
                ...
                var n = e.spec,
                  ...
                  a = n.domain,
                  c = n.ttlDays;
                r.set(t, i || "", Lo({ domain: a || "", expires: c || 10 }, o));
              });
            })(e),
            (function (e) {
              var r = e.filter(function (e) {
    ...
    (Zo.prototype.catch = function (e) {
      ...
      (Zo.prototype.then = function (e, n) {
        var t = new this.constructor(Yo);
        return ei(this, new oi(e, n, t)), t;
      }),
      ...
      (Zo.all = function (e) {
        return new Zo(function (n, t) {
          if (!Ko(e)) return t(new TypeError("Promise.all accepts an array"));
      ...
      (Zo.resolve = function (e) {
        return e && "object" === Vo(e) && e.constructor === Zo
          ? e
          : new Zo(function (n) {
              n(e);
            });
      ...
      (Zo.race = function (e) {
        return new Zo(function (n, t) {
          if (!Ko(e)) return t(new TypeError("Promise.race accepts an array"));
    ...
    var $t,
      Gt =
        (($t = Object.freeze({ __proto__: null, default: Zo })) &&
          $t.default) ||
        $t,
      Kt =
      ...
      Pr = function (e, n) {
        e.mergeQuery({ personalization: Lo({}, n) });
      },
      qr = function (e) {
        var n = e.decisions,
          t = e.renderAttempted;
      ...
      xr = function () {
        var e =
          ...
          t = { propositions: qr({ decisions: e, renderAttempted: n }) };
      ...
      jr = function (e) {
        var n,
          ...
          c = Nr(a.unmatchedDecisions, vt, gt),
          u = (function (e) {
            var n = [],
              t = [],
              r = {};
        ...
        return {
          ...
          nonAutoRenderableDecisions: [].concat(
            Qo(a.matchedDecisions),
            Qo(c.unmatchedDecisions),
            Qo(d)
          ),
        };
      },
          ...
          return Promise.resolve(a)
            ...
            .then(function (e) {
              return (function (e) {
                ...
                return {
                  decisions: n,
                  propositions: qr({ decisions: n, renderAttempted: !1 }),
                };
              })({ propositions: e });
            });
        };
      ...
      Hr = function (e) {
        var n,
          ...
          })({ collect: i, window: window, logger: o, showContainers: _t }),
          v = (function (e) {
            var n = e.viewCache,
              ...
              return Promise.resolve(a)
                ...
                .then(function (e) {
                  return (
                    ...
                    r(),
                    [].concat(
                      Qo(e.pageWideScopeDecisions),
                      Qo(e.viewPropositions)
                    )
                  );
                })
                .then(function (e) {
                  return {
                    decisions: Qo(c),
                    propositions: [].concat(
                      Qo(qr({ decisions: e, renderAttempted: !0 })),
                      Qo(qr({ decisions: c, renderAttempted: !1 }))
                    ),
                  };
                });
            };
              ...
              return o.getView(u).then(function (e) {
                return i.isRenderDecisions()
                  ? r(e).then(function (r) {
                      ...
                      c(function () {
                        return t({ decisionsMeta: [], viewName: u }), xr(e, !0);
                      });
                    })
                  : (c(function () {
                      return xr(e, !1);
    ...
    (Hr.namespace = "Personalization"),
      (Hr.configValidators = { prehidingStyle: ln().nonEmpty() });
    var _r,
      Lr = "2.12.0",
      Vr = (function (e) {
        return function (n) {
    ...
    var uo = function (e) {
      var n = (function (e) {
        var n = e.config,
          ...
          r = [].concat(Qo(t.getCommandNames()), [qn, xn]).sort(),
          o = Lo({}, n);
        return (
          Object.keys(n).forEach(function (e) {
            var t = n[e];
    ...
    var lo,
      po,
      go = [An, Un, ct, ft, Hr, Gr, io, co, uo, fo],
      vo = function (e) {
        var n = e.options,
      ...
      Co = function (e) {
        var n = e.shift() || [],
          t = e.shift() || [],
          r = e;
        return f.apply(void 0, [{}].concat(Qo(n), Qo(t), Qo(r)));
      },
      Eo = function (e) {
        return function (n) {
          var t = function () {
      ...
      Io = "The server responded with a",
      Do = [429, 503, 502, 504],
      Ro = function (e) {
        var n = e.response;
        return e.retriesAttempted < 3 && o(Do, n.statusCode);
      },
      So = function (e) {
        var n = e.response,
            ...
            configureCommand: function (e) {
              var t = vo({
                ...
                l = (function (e) {
                        ...
                        return (s ? r : t)(c, d).then(function (t) {
                          ...
                          return (
                            n.logOnNetworkResponse(
                              Lo(
                                Lo({ requestId: a, url: c, payload: f }, t),
                                {},
                  ...
                  sendFetchRequest: To,
                  sendBeaconRequest: f,
                  isRequestRetryable: Ro,
                  getRequestRetryDelay: So,
                }),
                p = (function (e) {
                  var n = e.logger;
                  return function (e) {
    ...
    (po = window.__alloyNS) &&
      po.forEach(function (e) {
        var n = vn({
          ...
          })(Bo({ instanceName: e, logController: n })),
          r = window[e].q;
        (r.push = t),
        ...
        Zo._immediateFn(function () {
          ...
          if (null !== t) {
            ...
            try {
              ...
              return void ti(n.promise, e);
            }
            ni(n.promise, r);
          } else (1 === e._state ? ni : ti)(n.promise, e._value);
        }))
      : e._deferreds.push(n);
  }
  function ni(e, n) {
    try {
      ...
      if (n && ("object" === Vo(n) || "function" == typeof n)) {
        var t = n.then;
        if (n instanceof Zo) return (e._state = 3), (e._value = n), void ri(e);
      ...
      (e._state = 1), (e._value = n), ri(e);
    } catch (n) {
      ti(e, n);
    }
  }
  function ti(e, n) {
    (e._state = 2), (e._value = n), ri(e);
  }
  function ri(e) {
    2 === e._state &&
    ...
    for (var n = 0, t = e._deferreds.length; n < t; n++) ei(e, e._deferreds[n]);
    e._deferreds = null;
  }
  function oi(e, n, t) {
